...
- ![](res/sprites/powerup_flamepass.png) *FlamePassItem* Thông thường, nếu Bomber đi vào vùng Flame ![](res/sprites/explosion_horizontal2.png) thì Bomber sẽ chết ![](res/sprites/player_dead1.png) , nhưng sau khi ăn vật phẩm này thì Bomber có thể chạy qua lửa mà không chết.
-  ![](res/sprites/powerup_wallpass.png) *WallPassItem* Ban đầu khi chưa kích hoạt vật phẩm thì nhân vật không thể đi qua các vật cản như Wall ![](res/sprites/wall.png) hay Brick ![](res/sprites/brick.png) ..., nhưng khi nhân vật ăn được vật phẩm này thì Bomber có thể chạy xuyên các vật cản trên.
-  ![](res/sprites/powerup_bombpass.png) *BombPassItem* Khi sử dụng Item này, Bomber sẽ được đi qua bomb đã đặt.
...
- ![](res/sprites/oneal_left1.png) *Oneal* có tốc độ di chuyển thay đổi, lúc nhanh, lúc chậm và di chuyển "thông minh" hơn so với Balloom.
- ![](res/sprites/doll_left1.png) *Doll* có tốc độ di chuyển nhanh hơn, và di chuyển "thông minh" hơn so với Balloom và Oneal.
- ![](res/sprites/kondoria_left1.png) *Kondoria* có tốc độ di chuyển nhanh hơn, và di chuyển "thông minh" hơn so với Balloom và Oneal , đồng thời có thể đi xuyên tường.
- ![](res/sprites/minvo_left1.png) *Minvo* có tốc độ di chuyển nhanh hơn, và di chuyển "thông minh" hơn so với Kondoria , đồng thời có thể đi xuyên tường.
- ![](res/sprites/ghost.png) *Ghost* có tốc độ di chuyển nhanh hơn, và di chuyển "thông minh" hơn so với Minvo , đồng thời có thể đi xuyên tường.
