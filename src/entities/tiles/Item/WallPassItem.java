...
public class WallPassItem extends Item {
    /**
     * Constructor WallPassItem 3 parameters.
     *
     * @param x      - x
     * @param y      - y
     * @param sprite - sprite
    ...
    /**
     * Constructor WallPassItem 2 parameters.
     *
     * @param x - x
     * @param y - y
     */
    public WallPassItem(int x, int y) {
        ...
        this.addBelowSprite(Sprite.powerup_wallpass);
    }
    ...
    public boolean collide(Entity e) {
        ...
        if (Objects.equals(this._sprite, Sprite.powerup_wallpass)) {
